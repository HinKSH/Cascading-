...
\cb3 num_of_inital_adopters = [\cf5 \strokec5 1\cf4 \strokec4 , \cf5 \strokec5 10\cf4 \strokec4 , \cf5 \strokec5 50\cf4 \strokec4 ]\cb1 \
\
\cf6 \cb3 \strokec6 ####function for random node effect on cascading behaviour\cf4 \cb1 \strokec4 \
...
\
\cf6 \cb3 \strokec6 ####function for key node effect on cascading behaviour\cf4 \cb1 \strokec4 \
\cf7 \cb3 \strokec7 def\cf4 \strokec4  \cf8 \strokec8 cascade_key_node\cf4 \strokec4 (\cf9 \strokec9 Graph\cf4 \strokec4 , \cf9 \strokec9 threshold\cf4 \strokec4 , \cf9 \strokec9 inital_adopters\cf4 \strokec4 ):\cb1 \
\cb3   q = Queue(maxsize = \cf5 \strokec5 0\cf4 \strokec4 ) \cf6 \strokec6 # Create infinite queue to store data\cf4 \cb1 \strokec4 \
...
\cb3       number_of_aff_nodes += \cf5 \strokec5 1\cf4 \cb1 \strokec4 \
\cb3   \cb1 \
\cb3   \cf2 \strokec2 return\cf4 \strokec4  (number_of_aff_nodes - \cf8 \strokec8 len\cf4 \strokec4 (inital_adopters))*\cf5 \strokec5 100\cf4 \strokec4  / (num_nodes - \cf8 \strokec8 len\cf4 \strokec4 (inital_adopters))\cb1 \
...
\
\cf6 \cb3 \strokec6 ####graph plotting\cf4 \cb1 \strokec4 \
...
\
\cf6 \cb3 \strokec6 #get the rank of the nodes\cf4 \cb1 \strokec4 \
...
\cb3     PRankH_node.append((rk,PRankH[rk]))\cb1 \
\cf6 \cb3 \strokec6 #arrange the node with higher rank to first\cf4 \cb1 \strokec4 \
\cb3 PRankH_node.sort(key=itemgetter(\cf5 \strokec5 1\cf4 \strokec4 ), reverse=\cf7 \strokec7 True\cf4 \strokec4 ) \cb1 \
\
\cf2 \cb3 \strokec2 try\cf4 \strokec4 :\cb1 \
\cb3     f=\cf8 \strokec8 open\cf4 \strokec4 (\cf10 \strokec10 "task2_result.txt"\cf4 \strokec4 ,\cf10 \strokec10 "w+"\cf4 \strokec4 )\cb1 \
...
\cb3   \cf8 \strokec8 print\cf4 \strokec4 (\cf10 \strokec10 "Type of initial adopters: Key Nodes(with high PRank nodes)"\cf4 \strokec4 )\cb1 \
...
\cb3   \cf2 \strokec2 for\cf4 \strokec4  i \cf7 \strokec7 in\cf4 \strokec4  \cf8 \strokec8 range\cf4 \strokec4 (num_of_test_per_threshold):\cf6 \strokec6 #loop 10 times\cf4 \cb1 \strokec4 \
\cb3   \cf6 \strokec6 #we generate the random key node by selecting them within 100 highest rank node obtained\cf4 \cb1 \strokec4 \
\cb3         key_node.append([])\cb1 \
\cb3         \cf2 \strokec2 for\cf4 \strokec4  j \cf7 \strokec7 in\cf4 \strokec4  \cf8 \strokec8 range\cf4 \strokec4 (num):\cb1 \
\cb3             rand = random.randint(\cf5 \strokec5 0\cf4 \strokec4 ,\cf5 \strokec5 100\cf4 \strokec4 )\cb1 \
\cb3             \cf6 \strokec6 #get the node with high page rank from the pagerank array randomly\cf4 \cb1 \strokec4 \
\cb3             \cf2 \strokec2 while\cf4 \strokec4  PRankH_node[rand][\cf5 \strokec5 0\cf4 \strokec4 ] \cf7 \strokec7 in\cf4 \strokec4  key_node[i]:\cb1 \
\cb3                 rand = random.randint(\cf5 \strokec5 0\cf4 \strokec4 ,\cf5 \strokec5 100\cf4 \strokec4 )\cb1 \
\cb3             key_node[i].append(PRankH_node[rand][\cf5 \strokec5 0\cf4 \strokec4 ])\cb1 \
\cb3   \cb1 \
...
\cb3         \cf2 \strokec2 for\cf4 \strokec4  time \cf7 \strokec7 in\cf4 \strokec4  range (num_of_test_per_threshold):\cb1 \
\cb3           cascade_value += cascade_key_node(MG,threshold,key_node[time])\cb1 \
\cb3         cascade_value = cascade_value/num_of_test_per_threshold\cb1 \
\cb3         \cf2 \strokec2 if\cf4 \strokec4  cascade_value != \cf5 \strokec5 0\cf4 \strokec4 :\cb1 \
...
\cb3       f.write(\cf10 \strokec10 "Type of initial adopters: Key nodes(with high PRank nodes)\\n"\cf4 \strokec4 )\cb1 \
...
\cb3         f.write(\cf10 \strokec10 "Threshold: "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (threshold_value[i])+\cf10 \strokec10 " Cascade Percentage(%): "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (cascade_percentage_arr[i])+\cf10 \strokec10 "\\n"\cf4 \strokec4 )\cb1 \
\cb3   \cf2 \strokec2 except\cf4 \strokec4 :\cb1 \
\cb3         \cf8 \strokec8 print\cf4 \strokec4 (\cf10 \strokec10 "Error"\cf4 \strokec4 )\cb1 \
\cb3   plt.plot(threshold_value,cascade_percentage_arr,label=\cf10 \strokec10 "Key nodes, Initial Adopters="\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (num))\cb1 \
\cb3   \cb1 \
\
\cb3 seed_arr = []\cb1 \
...
\cb3     threshold_value = []\cb1 \
\cb3     \cf2 \strokec2 for\cf4 \strokec4  threshold \cf7 \strokec7 in\cf4 \strokec4  \cf8 \strokec8 reversed\cf4 \strokec4 (\cf8 \strokec8 range\cf4 \strokec4 (\cf5 \strokec5 99\cf4 \strokec4 )):\cb1 \
\cb3         \cf2 \strokec2 if\cf4 \strokec4  threshold > \cf5 \strokec5 20\cf4 \strokec4  \cf7 \strokec7 and\cf4 \strokec4  ((threshold+\cf5 \strokec5 1\cf4 \strokec4 )%\cf5 \strokec5 5\cf4 \strokec4 )!=\cf5 \strokec5 0\cf4 \strokec4 :\cb1 \
\cb3             \cf2 \strokec2 continue\cf4 \cb1 \strokec4 \
\cb3         threshold = (threshold+\cf5 \strokec5 1\cf4 \strokec4 )/\cf5 \strokec5 100\cf4 \cb1 \strokec4 \
\cb3         cascade_value = \cf5 \strokec5 0\cf4 \cb1 \strokec4 \
...
\cb3             \cf2 \strokec2 break\cf4 \cb1 \strokec4 \
\cb3     \cf2 \strokec2 try\cf4 \strokec4 :\cb1 \
\cb3       f.write(\cf10 \strokec10 "Type of initial adopters: Key nodes(with all nodes)\\n"\cf4 \strokec4 )\cb1 \
\cb3       f.write(\cf10 \strokec10 "Number of initial adopters: "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (num)+\cf10 \strokec10 "\\n"\cf4 \strokec4 )\cb1 \
\cb3       f.write(\cf10 \strokec10 "Each threshold value has "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (num_of_test_per_threshold)+\cf10 \strokec10 " sets of initial adopters\\n"\cf4 \strokec4 )\cb1 \
\cb3       \cf2 \strokec2 for\cf4 \strokec4  i \cf7 \strokec7 in\cf4 \strokec4  \cf8 \strokec8 range\cf4 \strokec4 (\cf8 \strokec8 len\cf4 \strokec4 (threshold_value)):\cb1 \
\cb3         f.write(\cf10 \strokec10 "Threshold: "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (threshold_value[i])+\cf10 \strokec10 " Cascade percentage(%): "\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (cascade_percentage_arr[i])+\cf10 \strokec10 "\\n"\cf4 \strokec4 )\cb1 \
\cb3     \cf2 \strokec2 except\cf4 \strokec4 :\cb1 \
\cb3         \cf8 \strokec8 print\cf4 \strokec4 (\cf10 \strokec10 "Error"\cf4 \strokec4 )\cb1 \
\cb3     plt.plot(threshold_value,cascade_percentage_arr,label=\cf10 \strokec10 "Random nodes, Initial Adopters="\cf4 \strokec4 +\cf11 \strokec11 str\cf4 \strokec4 (num))\cb1 \
\cb3     \cb1 \
\cb3 plt.legend(title=\cf10 \strokec10 "Number of initial adopters"\cf4 \strokec4 )\cb1 \
\cf2 \cb3 \strokec2 try\cf4 \strokec4 :\cb1 \
\cb3     plt.savefig(\cf10 \strokec10 'task2_result.png'\cf4 \strokec4 )\cb1 \
\cf2 \cb3 \strokec2 except\cf4 \strokec4 :\cb1 \
\cb3     \cf8 \strokec8 print\cf4 \strokec4 (\cf10 \strokec10 "Error"\cf4 \strokec4 )\cb1 \
\cb3 plt.show()\cb1 \
\
